...
menu[menu_sub_main] = "Replacable menu";
...
option[menu_sub_settings,6] = "Set defaults";
...
///@desc Set/Refresh button strings
button[0] = scr_ButtonToString(global.button[BUTTON.RIGHT]);
button[1] = scr_ButtonToString(global.button[BUTTON.UP]);
button[2] = scr_ButtonToString(global.button[BUTTON.LEFT]);
button[3] = scr_ButtonToString(global.button[BUTTON.DOWN]);
button[4] = scr_ButtonToString(global.button[BUTTON.JUMP]);
button[5] = scr_ButtonToString(global.button[BUTTON.SHOOT]);
button[6] = scr_ButtonToString(global.button[BUTTON.RETRY]);
button[7] = scr_ButtonToString(global.button[BUTTON.PAUSE]);
button[8] = scr_ButtonToString(global.button[BUTTON.SUICIDE]);
button[10] = scr_ButtonToString(global.button_world[BUTTON_WORLD.MENU]);
button[11] = scr_ButtonToString(global.button_world[BUTTON_WORLD.QUIT]);
button[12] = scr_ButtonToString(global.button_world[BUTTON_WORLD.FULLSCREEN]);
button[13] = scr_ButtonToString(global.button_world[BUTTON_WORLD.SCREENSHOT]);
#endregion
